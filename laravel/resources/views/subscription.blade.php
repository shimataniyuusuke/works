                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <button type="button"
                        ...
                        <svg class="w-4 h-4 mr-2 -ml-1" aria-hidden="true" focusable="false" data-prefix="fab"
                             data-icon="bitcoin" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    ...
                    <button type="button"
                        ...
                        <svg class="w-5 h-5 ml-2 -mr-1" aria-hidden="true" focusable="false" data-prefix="fab"
                    ...
                    <button type="button"
                        ...
                        <svg class="w-10 h-3 mr-2 -ml-1" viewBox="0 0 256 64" fill="none"
                             xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <button type="button"
                        ...
                        <svg class="w-4 h-4 mr-2 -ml-1 text-[#626890]" aria-hidden="true" focusable="false"
                             data-prefix="fab" data-icon="ethereum" role="img" xmlns="http://www.w3.org/2000/svg"
                             viewBox="0 0 320 512">
                            <path fill="currentColor"
