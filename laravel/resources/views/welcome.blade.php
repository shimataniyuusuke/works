        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            @auth
                <a href="{{ url('/dashboard') }}"
                   class="text-sm text-gray-700 dark:text-gray-500 underline">ダッシュボード</a>
            @else
    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold"><a href="login"
                                                                             class="underline text-gray-900 dark:text-white">会員画面</a>
                        </div>
                    </div>

                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            OAUTH・AUTH0を用いた会員・マイページ機能 <br>
                            @if (Route::has('login'))
                                @auth
                                    <a href="{{ url('/dashboard') }}">ダッシュボードへ</a>
                                @else
                                    <a href="{{ route('login') }}" class="ml-4 text-sm underline">ログイン</a>

                                    @if (Route::has('register'))
                                        <a href="{{ route('register') }}" class="ml-4 text-sm underline">登録</a>
                                    @endif
                                @endauth
                            @endif
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold"><a href="admin"
                                                                             class="underline text-gray-900 dark:text-white">管理画面</a>
                        </div>
                    </div>
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold"><a href="news"
                                                                             class="underline text-gray-900 dark:text-white">News</a>
                        </div>
                    </div>
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">
                            <a href="subscription" class="underline text-gray-900 dark:text-white">決済</a>
                        </div>
                    </div>
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white"><a
                                href="subscription" class="underline text-gray-900 dark:text-white">ソーシャルログイン</a></div>
                    </div>

                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            Facebook・Google・Amazon・アップル・Twitter・LINEの<br>
                            アカウントでのログインを実装
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">
                            <a href="scraping_page" class="underline text-gray-900 dark:text-white">全文検索</a>
                        </div>
                    </div>
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">
                            <a href="heatmap" class="underline text-gray-900 dark:text-white">ヒートマップ</a>
                        </div>
                    </div>

                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            （未実装）LPなどに組み込んで熟読エリアや離脱エリアの可視化をして利益向上を図ります
                        </div>
                    </div>
                </div>
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
        ...
        <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
            <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">
                Laravel version-{{ Illuminate\Foundation\Application::VERSION }} (PHP version-{{ PHP_VERSION }})
            </div>
        </div>
    </div>
</div>
